...
$(document).ready(function () {
    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.reservations.length; i++) {
        ...
        reservation.pickup_date =
          reservation.pickup_date.getFullYear() +
          "-" +
          (reservation.pickup_date.getMonth() + 1) +
          "-" +
          reservation.pickup_date.getDate();
        reservation.return_date =
          reservation.return_date.getFullYear() +
          "-" +
          (reservation.return_date.getMonth() + 1) +
          "-" +
          reservation.return_date.getDate();
        reservation.reserve_date =
          reservation.reserve_date.getFullYear() +
          "-" +
          (reservation.reserve_date.getMonth() + 1) +
          "-" +
          reservation.reserve_date.getDate();
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.cars.length; i++) {
        ...
        dis = "";
        if (status_codes[0] == "Rented") dis = "disabled";
        var row =
          "<tr><td>" +
          car.plate_id +
          "</td>" +
          ...
          car.registration_date.substr(0, 10) +
          "</td><td>" +
          car.make +
          "</td><td>" +
          car.model +
          ...
          "</td><td>" +
          car.price +
          '<td><button style="padding: 0;border: none;background: none; "><img src="/remove.png" width=25 height=25> </button></td>' +
          "</td></tr>";
  ...
  $(".office-cars").on("click", "button", function (e) {
    //console.log($(this).closest('tr').children('td:first').text());
    $(this).closest("tr").photos / car.png();
    $.ajax({
      url: "/delete-car",
      type: "POST",
      data: {
